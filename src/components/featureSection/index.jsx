  ...
  return (
    <section className="features">
      ...
      <div className="feature-item">
        <img src="designs/icon-chat.png" alt="Chat Icon" className="feature-icon" />
      ...
      <div className="feature-item">
        <img src="designs/icon-money.png" alt="Chat Icon" className="feature-icon" />
        <h3 className="feature-item-title">More savings means higher rates</h3>
        <p>The more you save with us, the higher your interest rate will be!</p>
      </div>
      <div className="feature-item">
        <img src="designs/icon-security.png" alt="Chat Icon" className="feature-icon" />
